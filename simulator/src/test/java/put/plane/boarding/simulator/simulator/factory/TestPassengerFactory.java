...
public class TestPassengerFactory {
    ...
    public SimulatorPassenger createDefault(Plane plane, int row, int column, int passengerSpeed, int queueEnteringSpeed) {
    ...
    public SimulatorPassenger createLuggage(Plane plane, int row, int column, int passengerSpeed, int queueEnteringSpeed, int baggageLocation, int pickupDuration) {
        SimulatorPassenger result = createDefault(plane, row, column, passengerSpeed, queueEnteringSpeed);
